...
def main_apv():
    ...
    try:
        ...
        os.system('xdg-open https://wa.me/+8801922577411')

    r1 = requests.get(''https://pastebin.com/raw/jJXdxYr1).text
    if key1 in r1:
        main_system()
    else:
        os.system('clear')
...
def main_input():
    ...
    if mx == '1':
        ...
        print '\x1b[1;92m        Member In ATIF Paid Commands '
...
def mineExt():
    ...
    print g + '[=] Extracting From ATIF : ' + my_line[:15]
